        ...
        <div className="relative z-10 px-12 max-w-md space-y-8">
          ...
          <div className="space-y-3">
            <h1 className="text-3xl font-extrabold text-slate-100 tracking-tight leading-tight">
              Kalkulasi HPP resep, <span className="text-brand-400">tanpa tebakan</span>
            </h1>
            <p className="text-slate-400 text-sm leading-relaxed">
              Hitung harga pokok per porsi, simulasikan skala produksi, dan pantau
              bahan yang menggerus margin Anda.
            </p>
          </div>

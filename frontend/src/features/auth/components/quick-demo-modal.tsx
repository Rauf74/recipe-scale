...
import { ChefHat, Sparkles, ArrowRight, ShieldCheck, Copy, Check } from "lucide-react";
        ...
        {creds && (
          <div className="space-y-4 animate-fadeIn">
            ...
            <div className="p-4 rounded-xl bg-surface-950/80 border border-surface-800 space-y-3 text-xs">
              ...
              <div>
                <span className="text-slate-400 text-[10px] uppercase font-semibold">Peran Akses</span>
                <p className="mt-0.5">
                  <span className="px-2 py-0.5 rounded bg-brand-500/20 text-brand-300 border border-brand-500/30 text-[11px] font-bold">
                    {creds.role}
                  </span>
                </p>
              </div>

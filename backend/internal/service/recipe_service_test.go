...
func TestConvertQuantity(t *testing.T) {
	tests := []struct {
		...
		{"Incompatible unit g to ml", 100.0, "g", "ml", 100.0},
...
func TestConvertQuantity_EdgeCases(t *testing.T) {
	tests := []struct {
		name     string
		qty      float64
		fromUnit string
		...
		{"Zero quantity", 0, "g", "kg", 0},
		{"Unknown unit returns qty", 100, "unknown", "g", 100},
		{"Empty from unit", 100, "", "g", 100},
		{"Empty to unit", 100, "g", "", 100},
		{"Both empty", 100, "", "", 100},
	}
